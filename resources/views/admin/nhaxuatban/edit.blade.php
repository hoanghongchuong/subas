...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form name="frmAdd" method="post" action="backend/nhaxuatban/edit/{{$data->id}}" enctype="multipart/form-data">
	                  		...
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
							    	...
							    	<div class="form-group @if ($errors->first('txtName')!='') has-error @endif">
								      	...
								      	<input type="text" name="txtName" id="txtName" value="{{$data->name}}" required="required" class="form-control" />
			    ...
			    <div class="box-footer">
			    	<div class="row">
						<div class="col-md-6">
					    	...
					    	<button type="button" onclick="javascript:window.location='backend/nhaxuatban'" class="btn btn-danger">Thoát</button>
				    	</div>
			    	</div>
			  	</div>
		    </form>
