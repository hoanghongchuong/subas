          ...
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center with_dieuhuong">{{$item->slug}}</td>  
                <td class="text-center with_dieuhuong">
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/tag/edit/{{$item->id}}">Edit</a>
                </td>
                <td class="text-center">
                  <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="backend/tag/delete/{{$item->id}}">Delete</a>
                </td>
              </tr>
              @endforeach
            </tbody>
