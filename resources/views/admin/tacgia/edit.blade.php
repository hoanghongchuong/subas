...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form name="frmAdd" method="post" action="backend/tacgia/edit/{{$data->id}}" enctype="multipart/form-data">
			    ...
			    <div class="box-footer">
			    	<div class="row">
						<div class="col-md-6">
					    	...
					    	<button type="button" onclick="javascript:window.location='backend/tacgia'" class="btn btn-danger">Thoát</button>
				    	</div>
			    	</div>
			  	</div>
		    </form>
