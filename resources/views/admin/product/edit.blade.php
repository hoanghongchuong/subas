        ...
        <div class="box-body">
        	<form method="post" name="frmEditProduct" action="backend/product/edit?id={{$id}}&type={{ @$_GET['type'] }}" enctype="multipart/form-data">
			    ...
			    <div class="col-md-6">
					...
					<!-- <div class="form-group">
					    <label>
				        	<input type="checkbox" name="noibat" {!! (!isset($data->noibat) || $data->noibat==1)?'checked="checked"':'' !!}> Sách đặc biệt
				    	</label>
				    </div> -->
					<!-- <div class="form-group">
					    <label>
				        	<input type="checkbox" name="xuthe" {!! (!isset($data->xuthe) || $data->xuthe==1)?'checked="checked"':'' !!}> Sách giảm giá
				    	</label>
				    </div> -->
			    </div>
			    <div class="clearfix"></div>
