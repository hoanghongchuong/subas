...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form name="frmAdd" method="post" action="backend/theloai/edit/{{$data->id}}" enctype="multipart/form-data">
			    ...
			    <div class="box-footer">
			    	<div class="row">
						<div class="col-md-6">
					    	...
					    	<button type="button" onclick="javascript:window.location='backend/theloai'" class="btn btn-danger">Thoát</button>
				    	</div>
			    	</div>
			  	</div>
		    </form>
